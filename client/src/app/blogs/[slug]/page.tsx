  ...
  return (
    <div className="w-full font-sans bg-[#FFFAF7] min-h-screen pb-12 md:pb-20">
      ...
      <div className="max-w-[1000px] mx-auto pt-8 md:pt-12 px-4 md:px-6">
        ...
        <div className="w-full h-[250px] md:h-[600px] rounded-[16px] md:rounded-[24px] overflow-hidden mb-8 md:mb-10 shadow-lg relative">
          <Image src={post.heroImage || post.image} alt={post.title} fill className="object-cover" />
        </div>
