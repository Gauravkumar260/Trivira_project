        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 w-full">
           {blogPosts.map((post) => (
             ...
             >
               ...
               <div className="h-[250px] md:h-[300px] w-full overflow-hidden bg-trivira-cream p-3 md:p-4">
                 <img 
                   src={post.image} 
                   alt={post.title} 
                   className="w-full h-full object-cover rounded-[14px] md:rounded-[18px] transform group-hover:scale-105 transition duration-700"
                 />
               </div>
