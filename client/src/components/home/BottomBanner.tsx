...
import mascot2 from '@/assets/images/mascots/mascot-2.svg';
import mascot3 from '@/assets/images/mascots/mascot-3.svg';
import mascot4 from '@/assets/images/mascots/mascot-4.svg';
import mascot5 from '@/assets/images/mascots/mascot-5.svg';
import mascot6 from '@/assets/images/mascots/mascot-6.svg';
import mascot7 from '@/assets/images/mascots/mascot-7.svg';
  ...
  return (
    <div className="bg-[#FCF2E7] w-full flex flex-col items-center justify-center py-8 md:py-[64px] gap-6 md:gap-[80px] overflow-hidden">
      ...
      <div className="flex flex-nowrap justify-between items-end w-full max-w-[1384px] px-2 md:px-8 gap-1 md:gap-0">
        {[
          { img: assets.mascots.cordyceps, w: 'w-[11%]' },
          ...
          { img: assets.mascots.stevia, w: 'w-[14%]' },
        ].map((mascot, index) => (
